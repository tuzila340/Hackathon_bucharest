...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React25 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore2 = shim.useSyncExternalStore, useRef17 = React25.useRef, useEffect9 = React25.useEffect, useMemo16 = React25.useMemo, useDebugValue2 = React25.useDebugValue;
...
var createSelectorMemoized = (...selectors2) => {
  const cache = /* @__PURE__ */ new WeakMap();
  let nextCacheId = 1;
  const combiner = selectors2[selectors2.length - 1];
  const nSelectors = selectors2.length - 1 || 1;
  const argsLength = combiner.length - nSelectors;
  if (argsLength > 3) {
    throw new Error(true ? "Unsupported number of arguments" : formatErrorMessage_default(2));
  }
  const selector = (state, a1, a2, a3) => {
    ...
    if (!fn) {
      let reselectArgs = selectors2;
      const selectorArgs = [void 0, void 0, void 0];
      switch (argsLength) {
        case 0:
          break;
        case 1: {
          reselectArgs = [...selectors2.slice(0, -1), () => selectorArgs[0], combiner];
          break;
        }
        case 2: {
          reselectArgs = [...selectors2.slice(0, -1), () => selectorArgs[0], () => selectorArgs[1], combiner];
          break;
        }
        case 3: {
          reselectArgs = [...selectors2.slice(0, -1), () => selectorArgs[0], () => selectorArgs[1], () => selectorArgs[2], combiner];
          break;
        }
        default:
          throw new Error(true ? "Unsupported number of arguments" : formatErrorMessage_default(2));
...
function useFloating2(options = {}) {
  ...
  const [localDomReference, setLocalDomReference] = React16.useState(void 0);
...
function useListNavigation(context, props) {
  ...
  const cancelQueuedFocusRef = React22.useRef(null);
...
function useRole(context, props = {}) {
  ...
  const floatingId = React23.useMemo(() => {
    var _a;
  ...
  const item = React23.useCallback(({
    active,
    selected
  }) => {
    const commonProps = {
...
use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-MGHFNV6M.js.map
