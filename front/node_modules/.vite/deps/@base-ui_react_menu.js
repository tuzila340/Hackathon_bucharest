import {
  ...
  useScrollLock
} from "./chunk-Z6EQDA24.js";
import {
  useButton
} from "./chunk-R2YH7B3J.js";
import {
  useControlled
} from "./chunk-N7RWXVEW.js";
...
import {
  ...
  useTypeahead,
  useValueAsRef
} from "./chunk-JFGWMJT2.js";
import {
  useCompositeRootContext
} from "./chunk-WIJJIIEP.js";
import {
  clamp,
  contains,
...
var MenuCheckboxItem = React10.forwardRef(function MenuCheckboxItem2(componentProps, forwardedRef) {
  const {
    render,
    className,
    id: idProp,
...
var MenuCheckboxItemIndicator = React11.forwardRef(function MenuCheckboxItemIndicator2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
  ...
  const indicatorRef = React11.useRef(null);
  const {
    transitionStatus,
    setMounted
...
var MenuGroupContext = React12.createContext(void 0);
if (true) MenuGroupContext.displayName = "MenuGroupContext";
function useMenuGroupRootContext() {
  const context = React12.useContext(MenuGroupContext);
  if (context === void 0) {
...
var MenuGroup = React13.forwardRef(function MenuGroup2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
  ...
  const [labelId, setLabelId] = React13.useState(void 0);
...
var MenuGroupLabel = React14.forwardRef(function MenuGroupLabelComponent(componentProps, forwardedRef) {
  const {
    className,
    render,
    id: idProp,
...
var MenuItem = React15.forwardRef(function MenuItem2(componentProps, forwardedRef) {
  const {
    render,
    className,
    id: idProp,
...
var MenuLinkItem = React16.forwardRef(function MenuLinkItem2(componentProps, forwardedRef) {
  const {
    render,
    className,
    id: idProp,
...
var ToolbarRootContext = React17.createContext(void 0);
if (true) ToolbarRootContext.displayName = "ToolbarRootContext";
function useToolbarRootContext(optional) {
  const context = React17.useContext(ToolbarRootContext);
  if (context === void 0 && !optional) {
...
var MenuPopup = React18.forwardRef(function MenuPopup2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
  ...
  const setPopupElement = React18.useCallback((element2) => {
...
var MenuPortalContext = React19.createContext(void 0);
if (true) MenuPortalContext.displayName = "MenuPortalContext";
function useMenuPortalContext() {
  const value = React19.useContext(MenuPortalContext);
  if (value === void 0) {
...
var MenuPortal = React20.forwardRef(function MenuPortal2(props, forwardedRef) {
  const {
    keepMounted = false,
    ...portalProps
  } = props;
...
function useAnchorPositioning(params) {
  ...
  const [mountSide, setMountSide] = React21.useState(null);
  ...
  const arrowRef = React21.useRef(null);
  ...
  const autoUpdateOptions = React21.useMemo(() => ({
  ...
  const registeredPositionReferenceRef = React21.useRef(null);
  useIsoLayoutEffect(() => {
    if (!mounted) {
      return;
    }
...
function useAnchoredPopupScrollLock(enabled, touchOpen, positionerElement, referenceElement) {
  const [touchOpenShouldLockScroll, setTouchOpenShouldLockScroll] = React22.useState(false);
  useIsoLayoutEffect(() => {
...
var MenuPositioner = React23.forwardRef(function MenuPositioner2(componentProps, forwardedRef) {
  var _a;
  const {
    anchor: anchorProp,
  ...
  const previousTriggerRef = React23.useRef(null);
...
var MenuRadioGroupContext = React24.createContext(void 0);
if (true) MenuRadioGroupContext.displayName = "MenuRadioGroupContext";
function useMenuRadioGroupContext() {
  const context = React24.useContext(MenuRadioGroupContext);
  if (context === void 0) {
...
var MenuRadioGroup = React25.memo(React25.forwardRef(function MenuRadioGroup2(componentProps, forwardedRef) {
  const {
    render,
    className,
    value: valueProp,
...
var MenuRadioItemContext = React26.createContext(void 0);
if (true) MenuRadioItemContext.displayName = "MenuRadioItemContext";
function useMenuRadioItemContext() {
  const context = React26.useContext(MenuRadioItemContext);
  if (context === void 0) {
...
var MenuRadioItem = React27.forwardRef(function MenuRadioItem2(componentProps, forwardedRef) {
  const {
    render,
    className,
    id: idProp,
...
var MenuRadioItemIndicator = React28.forwardRef(function MenuRadioItemIndicator2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
...
var MenuStore = class _MenuStore extends ReactStore {
  constructor(initialState) {
    super({
      ...
      positionerRef: React29.createRef(),
      popupRef: React29.createRef(),
      typingRef: {
        current: false
      },
      itemDomElements: {
      ...
      triggerFocusTargetRef: React29.createRef(),
      beforeContentFocusGuardRef: React29.createRef(),
...
var MenuSubmenuRootContext = React30.createContext(void 0);
if (true) MenuSubmenuRootContext.displayName = "MenuSubmenuRootContext";
function useMenuSubmenuRootContext() {
  return React30.useContext(MenuSubmenuRootContext);
}
...
var MenuRoot = fastComponent(function MenuRoot2(props) {
  ...
  const parentFromContext = React31.useMemo(() => {
  ...
  const floatingParentNodeId = store.useState("floatingParentNodeId");
  const openEventRef = React31.useRef(null);
  ...
  const allowOutsidePressDismissalRef = React31.useRef(parent.type !== "context-menu");
  ...
  const allowTouchToCloseRef = React31.useRef(true);
  ...
  const handleImperativeClose = React31.useCallback(() => {
  ...
  React31.useImperativeHandle(ctx == null ? void 0 : ctx.positionerRef, () => positionerElement, [positionerElement]);
  React31.useImperativeHandle(ctx == null ? void 0 : ctx.actionsRef, () => ({
    setOpen
  }), [setOpen]);
  ...
  const direction = useDirection();
  const setActiveIndex = React31.useCallback((index) => {
  ...
  const onTypingChange = React31.useCallback((nextTyping) => {
  ...
  const activeTriggerProps = React31.useMemo(() => {
  ...
  const inactiveTriggerProps = React31.useMemo(() => {
  ...
  const popupProps = React31.useMemo(() => getFloatingProps({
    onMouseMove() {
      store.set("allowMouseEnter", true);
      if (parent.type === "menu") {
        store.set("hoverEnabled", false);
  ...
  const itemProps = React31.useMemo(() => getItemProps(), [getItemProps]);
  store.useSyncedValues({
    floatingRootContext,
    activeTriggerProps,
...
function useCompositeItem(params = {}) {
  ...
  const compositeProps = React33.useMemo(() => ({
...
function useTriggerFocusGuards(store, triggerElementRef) {
  const preFocusGuardRef = React34.useRef(null);
...
function useMixedToggleClickHandler(params) {
  ...
  const ignoreClickRef = React35.useRef(false);
...
var MenuTrigger = fastComponentRef(function MenuTrigger2(componentProps, forwardedRef) {
  ...
  const floatingTreeRoot = React36.useMemo(() => {
  ...
  if (isOpenedByThisTrigger) {
    return (0, import_jsx_runtime10.jsxs)(React36.Fragment, {
      ...
      }, `${thisTriggerId}-pre-focus-guard`), (0, import_jsx_runtime10.jsx)(React36.Fragment, {
        children: element
...
function useStickIfOpen(open, openReason) {
  ...
  const [stickIfOpen, setStickIfOpen] = React36.useState(false);
  useIsoLayoutEffect(() => {
...
function usePopupAutoResize(parameters) {
  ...
  const committedDimensionsRef = React38.useRef(null);
  const liveDimensionsRef = React38.useRef(null);
  const isInitialRenderRef = React38.useRef(true);
  const restoreAnchoringStylesRef = React38.useRef(NOOP);
  const onMeasureLayout = useStableCallback(onMeasureLayoutParam);
  const onMeasureLayoutComplete = useStableCallback(onMeasureLayoutCompleteParam);
  const anchoringStyles = React38.useMemo(() => {
...
function usePopupViewport(parameters) {
  ...
  const capturedNodeRef = React40.useRef(null);
  const [previousContentNode, setPreviousContentNode] = React40.useState(null);
  const [newTriggerOffset, setNewTriggerOffset] = React40.useState(null);
  const currentContainerRef = React40.useRef(null);
  const previousContainerRef = React40.useRef(null);
  const onAnimationsFinished = useAnimationsFinished(currentContainerRef, true, false);
  const cleanupFrame = useAnimationFrame();
  const [previousContentDimensions, setPreviousContentDimensions] = React40.useState(null);
  const [showStartingStyleAttribute, setShowStartingStyleAttribute] = React40.useState(false);
  useIsoLayoutEffect(() => {
  ...
  const lastHandledTriggerRef = React40.useRef(null);
  useIsoLayoutEffect(() => {
  ...
  if (!isTransitioning) {
    ...
    childrenToRender = (0, import_jsx_runtime12.jsxs)(React40.Fragment, {
...
function usePopupContentKey(activeTriggerId, payload) {
  const [contentKey, setContentKey] = React40.useState(0);
  const previousActiveTriggerIdRef = React40.useRef(activeTriggerId);
  const previousPayloadRef = React40.useRef(payload);
  const pendingPayloadUpdateRef = React40.useRef(false);
  useIsoLayoutEffect(() => {
...
var MenuViewport = React41.forwardRef(function MenuViewport2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
...
var Separator = React42.forwardRef(function SeparatorComponent(componentProps, forwardedRef) {
  const {
    className,
    render,
...
var MenuSubmenuTrigger = React43.forwardRef(function SubmenuTriggerComponent(componentProps, forwardedRef) {
  const {
    render,
    className,
    label,
  ...
  const registerTrigger = React43.useCallback((element2) => {
  ...
  const handleTriggerElementRef = React43.useCallback((el) => {
