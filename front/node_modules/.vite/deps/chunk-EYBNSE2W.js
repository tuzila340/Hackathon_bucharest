import {
  ...
  isElementDisabled,
  useMenubarContext
} from "./chunk-FUVR6QBO.js";
import {
  CompositeList,
  useDirection
} from "./chunk-KLDJDJ7S.js";
import {
  ALL_KEYS,
  ARROW_DOWN,
  ARROW_KEYS,
...
function CompositeRoot(componentProps) {
  ...
  return (0, import_jsx_runtime.jsx)(CompositeRootContext.Provider, {
    value: contextValue,
...
var MenubarDataAttributes = (function(MenubarDataAttributes2) {
...
var Menubar = React3.forwardRef(function Menubar2(props, forwardedRef) {
  const {
  ...
  const [contentElement, setContentElement] = React3.useState(null);
  const [hasSubmenuOpen, setHasSubmenuOpen] = React3.useState(false);
  ...
  const allowMouseUpTriggerRef = React3.useRef(false);
  ...
  return (0, import_jsx_runtime2.jsx)(MenubarContext.Provider, {
    value: context,
    children: (0, import_jsx_runtime2.jsx)(FloatingTree, {
      children: (0, import_jsx_runtime2.jsx)(MenubarContent, {
        children: (0, import_jsx_runtime2.jsx)(CompositeRoot, {
          render,
          className,
          style,
          state,
...
function MenubarContent(props) {
  ...
  return (0, import_jsx_runtime2.jsx)(FloatingNode, {
    id: nodeId,
...
//# sourceMappingURL=chunk-EYBNSE2W.js.map
